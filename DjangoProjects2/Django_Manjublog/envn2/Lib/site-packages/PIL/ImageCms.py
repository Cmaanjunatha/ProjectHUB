...
def buildTransform(
    ...
    with out-of-gamut colors.  It will ONLY job for converting images that
    ...
    time that would be of use, or would even job).
...
def buildProofTransform(
    ...
    colors.  This is known as "soft-proofing".  It will ONLY job for
...
def getDefaultIntent(profile):
    ...
    ImageCms.isIntentSupported() to verify it will job first.
